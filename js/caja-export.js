/* ============================================================
   CAJA-EXPORT.JS  —  Exportación de movimientos a Excel (.xlsx)
...
(function () {
  ...
  const COLUMNAS_EXPORT = [
    ...
    { campo: "puntoVenta",    titulo: "Punto de Venta", format: v => v || "" },
  ...
  function exportar(alcance) {
    ...
    descargarBlob(aXLSX(filas), nombreArchivo("caja-movimientos"));
    window.mostrarToast(`✓ ${filas.length} movimientos exportados a Excel`);
  }
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    window.exportarMovimientosCSV     = exportar;  // alias heredado
